...
alias ipl_devproxy="cd. $WORKSPACE/iplayer-web-dev-proxy"
alias ipl_devscripts="cd. $WORKSPACE/iplayer-web-dev-scripts"
alias ipl_docs="cd. $WORKSPACE/iplayer-web-docs"
alias ipl_edge="cd. $WORKSPACE/iplayer-web-edge"
alias ipl_experimentation="cd. $WORKSPACE/iplayer-web-experimentation"
alias ipl_framework="cd. $WORKSPACE/iplayer-web-framework"
...
alias ipl_myprogrammes="cd. $WORKSPACE/iplayer-web-app-myprogrammes"
...
alias ipl_tipsimulcast="cd. $WORKSPACE/iplayer-web-tip-simulcast"
